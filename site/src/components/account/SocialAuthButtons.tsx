...
//
// STRUCTURE corrigée (chantier Compte, reprise) : § .oauth-buttons de la
// maquette est une grille à 2 colonnes (boutons côte à côte) — ce composant
// ne rend plus que cette grille ; le conteneur englobant (.oauth-choice,
// avec le séparateur "ou avec votre adresse e-mail") vit désormais dans
// AuthTabs.tsx, au plus près de la maquette réelle.
export default function SocialAuthButtons() {
  return (
    <>
      ...
      <p className="account-soon">Connexion Google / Facebook — bientôt disponible</p>
    </>
  );
}
