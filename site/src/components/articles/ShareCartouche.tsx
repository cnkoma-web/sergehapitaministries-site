...
// sans le cercle plein qui les encapsulait auparavant), disposées entre deux
// traits horizontaux fins plutôt que dans une capsule avec l'étiquette
// "Partager :". Chaque tracé SVG est le même qu'avant (dessiné pour rester
// lisible seul, sans dépendre du cercle) — seul le remplissage passe du
// blanc à la couleur de marque, et le cercle de fond est retiré.
//
