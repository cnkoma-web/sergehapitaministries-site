...
// Le <div className="v2-compte-page"> superflu (emprunté au Lot 5 pour le
// style .account-form) a été retiré : ForgotPasswordForm utilise désormais
// sa propre classe réelle .v2-account-flow-form (voir le composant).
