...
// V2 (Lot 4, 11/09) — calqué fichier pour fichier sur
// admin/rosee-matinale/page.tsx (même principe exact : publier bascule
// automatiquement l'ancienne entrée en archive, pas de bouton séparé).
// Différences volontaires (voir le commentaire détaillé dans
// publications/actions.ts) : pas de champ Titre, une référence biblique
// distincte du texte de la proclamation, pas d'image de couverture, corps
// obligatoire.
      ...
      <div className="editor-card" style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <form action={publishConfession}>
          ...
          <div className="editor-field">
            ...
            <input type="text" name="verse_reference" placeholder="Ex. Proverbes 18:20" />
          </div>
          <div className="editor-field">
            <label>Verset (affiché en tête, avec sa référence)</label>
            <textarea name="verse_text" rows={2} required />
          </div>
          <div className="editor-field">
